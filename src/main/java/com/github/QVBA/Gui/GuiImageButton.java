...
/**
 * @author zmaster587
 * https://github.com/zmaster587/libVulpes/blob/a35496e44d240ce4e46545eabd865027cfa32daf/src/main/java/zmaster587/libVulpes/gui/GuiImageButton.java
 */
public class GuiImageButton extends GuiButton {
	 ...
	 */
	public GuiImageButton(int id, int x, int y, int width, int height, ResourceLocation[] location, String displayString) {
	...
	public void drawButton(Minecraft minecraft, int par2, int par3)
	{
		if (this.visible)
		{
			...
			this.drawCenteredString(Minecraft.getMinecraft().fontRenderer, this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, 0xffffff);
		}
	}
}